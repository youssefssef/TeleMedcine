...
class HeartStatic extends StatefulWidget {
  const HeartStatic({super.key});

  @override
  State<HeartStatic> createState() => _HeartStaticState();
}

class _HeartStaticState extends State<HeartStatic> {
